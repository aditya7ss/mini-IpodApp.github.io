...
class App extends React.Component {
	...
	constructor() {
		super();
		// State
		const song0 = new Audio(songs.music0);
		const song  = new Audio (songs.music);
		...
		this.state = {
			...
			songsList: {
				songs: [song0 ,song,song1, song2, song3,song4,],
				thumbnails: [images.song0img,images.songImg,images.song1Img, images.song2Img, images.song3Img,images.song4Img],
				songIndex: 0,
				name: ["Excuses","Apsraa","Stay", "Deserve You", "Yummy","Dekh_lena"],
				isPlaying: false,
			},
